...
public class CrudProducto extends JFrame {
	...
	private void createTable() {
		...
		//Crear el JTable
		//int id, String nombre, Float precio, String img, int proveedorid, int stock, String categoria
		String[] columnas = new String[] { "ID", "Nombre", "Precio", "Img", "Id Proveedor", "Categoria" };
